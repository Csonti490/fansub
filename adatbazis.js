...
var videoSources = {
    series: [
        ...
        },
        {
            ...
            ti: "Szinopszis", // Nothing
            de: `<div class="col-12 col-md-4 col-lg-3"><img src="img/rwby_chibi_2.jpg" onerror="KepHiba(this)" class="d-block mx-auto sorikep w-50 w-md-75"></div><div class="col-12 col-md-8 col-lg-9 text-justify my-auto border p-3" id="soriinfo">Join the cast of RWBY in a new series of cute, comedy shorts with infinite possibilities! It's playing tag! It's baking cookies! It's posing as police officers! It's... really quite absurd. It's RWBY CHIBI!</div>`,
            episodes: [ // Nothing
            ]
        },
        {
            ...
            ti: "Szinopszis", // Nothing
            de: `<div class="col-12 col-md-4 col-lg-3"><img src="img/rwby_chibi_3.jpg" onerror="KepHiba(this)" class="d-block mx-auto sorikep w-50 w-md-75"></div><div class="col-12 col-md-8 col-lg-9 text-justify my-auto border p-3" id="soriinfo">Join the cast of RWBY in a new series of cute, comedy shorts with infinite possibilities! It's playing tag! It's baking cookies! It's posing as police officers! It's... really quite absurd. It's RWBY CHIBI!</div>`,
            episodes: [ // Nothing
            ]
        },
        {
            ...
            ti: "Szinopszis", // Nothing
            de: `<div class="col-12 col-md-4 col-lg-3"><img src="img/rwby_chibi_4.jpg" onerror="KepHiba(this)" class="d-block mx-auto sorikep w-50 w-md-75"></div><div class="col-12 col-md-8 col-lg-9 text-justify my-auto border p-3" id="soriinfo">Join the cast of RWBY in a new series of cute, comedy shorts with infinite possibilities! It's playing tag! It's baking cookies! It's posing as police officers! It's... really quite absurd. It's RWBY CHIBI!</div>`,
            episodes: [ // Nothing
            ]
        },
        {
            title: "RWBY Beyond",
            ti: "Szinopszis", // Nothing
            de: `<div class="col-12 col-md-4 col-lg-3"><img src="img/rwby_beyond.png" onerror="KepHiba(this)" class="d-block mx-auto sorikep w-50 w-md-75"></div><div class="col-12 col-md-8 col-lg-9 text-justify my-auto border p-3" id="soriinfo">Join the cast of RWBY in a new series of cute, comedy shorts with infinite possibilities! It's playing tag! It's baking cookies! It's posing as police officers! It's... really quite absurd. It's RWBY CHIBI!</div>`,
            episodes: [ // Nothing
                {
                    title: "Jr. Detectives",
                    sourceCode: `<iframe class="w-75 d-block mx-auto" style="aspect-ratio: 16/9;" frameborder="0" src="https://mega.nz/embed/rw11nCaB#g5t3hRAybdFLr2cX3t7Ic3cYb6j8emhCtRRt_4W9z7k" allowfullscreen ></iframe>`,
