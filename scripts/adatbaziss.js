    ...
    series: [
        {
            ...
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_1
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=1
                ...
                },
                {
                    ...
                    description: `<p>2. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Ruby új barátra tesz szert, a vacak kardvívó, Jaune Arc személyében az első Beacon-ben töltött napja során.</p>`
                },
                {
                    buttonTitle: `3. rész`,
                ...
                },
                {
                    ...
                    description: `<p>6. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Yang és Blake boldogan összebarátkoznak, miközben Ruby és Weiss között nő a feszültség.</p>`
                },
                {
                    buttonTitle: `7. rész`,
                    ...
                    description: `<p>7. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Blake és Yang dolgai simán mennek, de minden délre megy, amikor a többi pár óriási szörnyekkel a sarkukban megjelenik.</p>`
                },
                {
                    buttonTitle: `8. rész`,
                ...
                },
                {
                    ...
                    description: `<p>11. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Jaune, az új Vadászok közül a legkevésbé tehetséges, zaklatástól szenved.</p>`
                },
                {
                    buttonTitle: `12. rész`,
                    ...
                    description: `<p>12. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Pyrrha egy tervvel áll elő, hogy segítsen Jaune-nak, de a dolgok bonyolulttá válnak, amikor elárulja, hogyan is került az iskolába.</p>`
                },
                {
                    buttonTitle: `13. rész`,
                    ...
                    description: `<p>13. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Chihana" title="Chihana csatija (Indavideó)" target="_blank">Chihana Fansub</a><br>Jaune-t egy-egy szörnyű helyzetbe zsarolják, de amikor Pyrrha egy aljas csínytevés célpontjává válik, szembeszáll kínzóival.</p>`
                },
                {
                    buttonTitle: `14. rész`,
        ...
        },
        {
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=2
                ...
                },
                {
                    ...
                    description: `<p>10. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Weiss, Blake és Yang azon töprengenek, hogy miért akarnak vadásznők lenni, míg Ruby megdöbbentő felfedezést tesz a föld mélyén.</p>`
                },
                {
                    buttonTitle: `11. rész`,
                    ...
                    description: `<p>11. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Az RWBY csapat az idő ellen küzd, hogy megakadályozza, hogy a vonat elérje a célját.</p>`
                },
                {
                    buttonTitle: `12. rész`,
        ...
        },
        {
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=3&ref_=ttep_ep_sn_nx
                ...
                },
                {
                    ...
                    description: `<p>3. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Winter megérkezése után Weiss és Ruby tudomást szerez a közte és Qrow közötti feszültségről.</p>`
                },
                {
                    buttonTitle: `4. rész`,
                    ...
                    description: `<p>4. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Mercury megmutatja óriási harcos képességeit. Ruby és Yang értékes tanácsokat kap Qrow-tól, míg Weiss életleckét tanul Wintertől.</p>`
                },
                {
                    buttonTitle: `5. rész`,
                    ...
                    description: `<p>5. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>A Vytal Fesztivál második fordulójában Yang és Weiss egy ismeretlen csapat ellen versenyeznek.</p>`
                },
                {
                    buttonTitle: `6. rész`,
                    ...
                    description: `<p>6. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Ozpin és Pyrrha megvitatják A négy lány történetét. Ezt követően Yang és Mercury harca döbbenetesen végződik.</p>`
                },
                {
                    buttonTitle: `7. rész`,
                ...
                },
                {
                    ...
                    description: `<p>9. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/bluedog327" title="bluedog327 csatija (Indavideó)" target="_blank">bluedog327</a><br>Pyrrah és Penny megkezdi a harcot. Ruby és Mercury elkezdi a magáét. Cinder halálos üzenetet küld.</p>`
                },
                {
                    buttonTitle: `10. rész`,
        ...
        },
        {
            ...
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_4
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=4
                {
                    ...
                    sourceCode: iimmgg,
                    description: `<p>Rövid leírás</p><p>???<br>Fanmade source: <a href="https://www.youtube.com/@bokorember1362" target="_blank">Bokor Ember</a></p>`
                },
                {
                    buttonTitle: `Opening`,
                ...
                },
                {
                    ...
                    description: `<p>2. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Rektilian" title="Thoma csatija (Indavideó)" target="_blank">Thoma</a><br>Az RNJR csapat megtalálja a mészárlás következményeit. Weisst az apja sarokba szorítja, és Ruby rájön egy szomorú igazságra.</p>`
                },
                {
                    buttonTitle: `3. rész`,
                ...
                },
                {
                    ...
                    description: `<p>6. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Rektilian" title="Thoma csatija (Indavideó)" target="_blank">Thoma</a><br>Weiss énekli a dalát, és az Atlas-i tudatlansággal küzd. Az RNJR csapat felfedez egy másik romvárost, és belefut egy halálos ellenfélbe.</p>`
                },
                {
                    buttonTitle: `7. rész`,
        ...
        },
        {
            ...
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_5 - Szinopszis
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=5 - részenként rövid leírás
                ...
                },
                {
                    ...
                    description: `<p>4. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Rektilian" title="Thoma csatija (Indavideó)">Thoma</a><br>Ruby és Oscar elkezdenek edzeni a kézi harcban. Yang megtalálja Raven táborát, de Weiss elrablásának felfedezése megnehezíti a találkozásukat.</p>`
                },
                {
                    buttonTitle: `5. rész`,
                    ...
                    description: `<p>5. rész rövid leírása</p><p>Blake és Sun nem kap elég aláírást a Haven Akadémia megmentésére irányuló petíciójukhoz. Mindeközben Ilia parancsot kap az Albain testvérektől, hogy gyilkolják meg Blake szüleit és fogják el Blake-et.</p>`
                },
                {
                    buttonTitle: `6. rész`,
                ...
                },
                {
                    ...
                    description: `<p>7. rész rövid leírása</p><p>Yang szembesíti Ozpint azzal, hogy mágiát használt Qrow-n és Ravenen, aki mindent elárul hatalmáról és a Hajadonok-ról. Eközben Cinder, Watts, Mercury és Emerald megérkezik Raven táborába.</p>`
                },
                {
                    buttonTitle: `8. rész`,
                    ...
                    description: `<p>8. rész rövid leírása</p><p>Az érzelmek fokozódnak, ahogy Ruby és Weiss rájön, hogy Yang még nem bocsátott meg Blake-nek. Ilia belső konfliktusa egyre nő. Blake rájön, hogy a családja veszélyben van.</p>`
                },
                {
                    buttonTitle: `9. rész`,
                    ...
                    description: `<p>9. rész rövid leírása</p><p>Raven táborát Cinder bandája megtámadja, miközben a Tavasz Hajadon után kutatnak. Ilia hagy egy levelet Blake-nek, amelyben arra kéri, hogy találkozzon vele titokban.</p>`
                },
                {
                    buttonTitle: `10. rész`,
                    episodeTitle: "True Colors / Igaz Színek",
                    sourceCode: iimmgg,
                    description: `<p>10. rész rövid leírása</p><p>Blake próbálja érvekkel meggyőzni Iliát, miközben Ghira és Sun - Corsac és Fennec ellen küzd.</p>`
                },
                {
                    buttonTitle: `11. rész`,
                    episodeTitle: "The More the Merrier / Minél Több, annál Jobb",
                    sourceCode: iimmgg,
                    description: `<p>11. rész rövid leírása</p><p>Ruby és a banda többi tagja találkozik Lionheart Professzorral a Haven Akadémián, és nem is sejtik, hogy épp csapdába sétálnak.</p>`
                },
                {
                    buttonTitle: `12. rész`,
                    episodeTitle: "Vault of the Spring Maiden / A Tavasz Hajadon Pincéje",
                    sourceCode: iimmgg,
                    description: `<p>12. rész rövid leírása</p><p>Hazel múltja napvilágra kerül. Jaune felfedez valamit magáról. Raven, Vernal és Cinder belép az alagsorba.</p>`
                },
                {
                    buttonTitle: `13. rész`,
                    episodeTitle: "Downfall / Bukás",
                    sourceCode: iimmgg,
                    description: `<p>13. rész rövid leírása</p><p>Ruby elvonja Emerald és Mercury figyelmét, így Yang üldözőbe vehette Ravent és Cindert. Adam arra készül, hogy lerombolja az iskolát, de Blake megérkezik a többi faunusszal, hogy őrizetbe vegyék.</p>`
                },
                {
                    buttonTitle: `14. rész`,
                    episodeTitle: "Haven's Fate / Haven Sorsa",
                    sourceCode: iimmgg,
                    description: `<p>14. rész rövid leírása</p><p>Emerald összeomlik, amikor megtudja Cinder vereségét, miközben Adam és Lionheart menekül, így Mercury és Hazel visszavonulásra kényszerülnek. Annak ellenére, hogy Yangben rövid ideig feszültség uralkodik, Blake-et üdvözli a csapatban.</p>`
                }
            ]
        },
        {
            projectTitle: "RWBY: 6.fejezet",
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_6
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=6
                ...
                },
                {
                    ...
                    description: `<p>2. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Tensza1" title="Tensza1 csatija (Indavideó)" target="_blank">Thoma</a><br>Az RWBY csapat ellenségei keresik a hollétüket. Eközben az RWBY csapat megkérdőjelezi Ozpint, miközben a múltja kísérteni kezdi.</p>`
                },
                {
                    buttonTitle: `3. rész`,
                    ...
                    description: `<p>3. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Tensza1" title="Tensza1 csatija (Indavideó)" target="_blank">Tensza1</a><br>Mi a kedvenc tündérmeséd?</p>`
                },
                {
                    buttonTitle: `4. rész`,
                    ...
                    description: `<p>4. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Tensza1" title="Tensza1 csatija (Indavideó)" target="_blank">Tensza1</a><br>Hősök és gazemberek egyaránt aggasztó leleplezésekkel szembesülnek.</p>`
                },
                {
                    buttonTitle: `5. rész`,
                    ...
                    description: `<p>5. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Tensza1" title="Tensza1 csatija (Indavideó)" target="_blank">Tensza1</a><br>A Mistral-i bűnszervezet még mindig tevékenykedik, de a menedék nem mindig garantálja a biztonságot.</p>`
                },
                {
                    buttonTitle: `6. rész`,
        ...
        },
        {
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=7&ref_=ttep_ep_sn_nx
                ...
                },
                {
                    ...
                    description: `<p>3. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Viharharcos" title="Viharharcos és Krissön csatija (Indavideó)" target="_blank">Viharharcos és Krissön</a><br>Kint a havas tundrában az Ace Ops bemutatja az RWBY és JNR csapatának a köteléket.</p>`
                },
                {
                    buttonTitle: `4. rész`,
                ...
                },
                {
                    ...
                    description: `<p>7. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Viharharcos" title="Viharharcos és Krissön csatija (Indavideó)" target="_blank">Viharharcos és Krissön</a><br>Meddig lennél hajlandó elmenni azért, hogy azt tedd, ami helyes?</p>`
                },
                {
                    buttonTitle: `8. rész`,
                ...
                },
                {
                    ...
                    description: `<p>9. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Viharharcos" title="Viharharcos és Krissön csatija (Indavideó)" target="_blank">Viharharcos és Krissön</a><br>Megmondod az igazat? Vagy valaki elmondja helyetted? A válasz mindent megváltoztathat a világon.</p>`
                },
                {
                    buttonTitle: `10. rész`,
                ...
                },
                {
                    ...
                    description: `<p>13. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Viharharcos" title="Viharharcos és Krissön csatija (Indavideó)" target="_blank">Viharharcos és Krissön</a><br>Ki leszel, ha a legnagyobb félelmeid megvalósulnak?</p>`
                }
            ]
        },
        {
            projectTitle: "RWBY: 8.fejezet",
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_8
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=8
                ...
                },
                {
                    ...
                    description: `<p>3. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Az emberiség sorsa megköveteli hőseinktől, hogy beszivárogjanak Atlasz legszigorúbban őrzött létesítményébe - mindezt egy nap alatt.</p>`
                },
                {
                    buttonTitle: `4. rész`,
                ...
                },
                {
                    ...
                    description: `<p>5. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Itt az esélyük, hogy elmondják a világnak az igazat. Meghallgatásra talál az üzenetük?</p>`
                },
                {
                    buttonTitle: `6. rész`,
                    ...
                    description: `<p>6. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Itt az idő.</p>`
                },
                {
                    buttonTitle: `7. rész`,
                    ...
                    description: `<p>7. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Atlaszban zaljik az egész háború. Hőseink lehetetlen problémával néznek szembe. Hova tovább?</p>`
                },
                {
                    buttonTitle: `8. rész`,
                    ...
                    description: `<p>8. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Nem vagyunk egyedül.</p>`
                },
                {
                    buttonTitle: `9. rész`,
                    ...
                    description: `<p>9. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Az óra Jaune, Ren és Yang mentőakcióján ketyeg. Az Ace-Ops tartja a vonalat Salem erőivel szemben.</p>`
                },
                {
                    buttonTitle: `10. rész`,
                    ...
                    description: `<p>10. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Ahogy a háború köde beborítja a királyságot, az Atlas a törésponthoz közeledik.</p>`
                },
                {
                    buttonTitle: `11. rész`,
                    ...
                    description: `<p>11. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>A Schnee uradalomban fokozódik a feszültség, ahogy újraegyesült hőseink a sarokba szorítják magukat.</p>`
                },
                {
                    buttonTitle: `12. rész`,
                    ...
                    description: `<p>12. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Kockázatos, veszélyes és szinte lehetetlen - de ez a legjobb tervük.</p>`
                },
                {
                    buttonTitle: `13. rész`,
                    ...
                    description: `<p>13. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>A legjobb tervek...</p>`
                },
                {
                    buttonTitle: `14. rész`,
                    ...
                    description: `<p>14. rész rövid leírása</p><p>A feliratot készítette: <a href="https://indavideo.hu/profile/Santii" title="Santii csatija (Indavideó)" target="_blank">Santii</a><br>Néha megéri az egészhez megkockáztatni a bukást.</p>`
                }
            ]
        },
        {
            projectTitle: "RWBY 9. fejezet",
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Volume_9
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=9
                ...
                },
                {
                    ...
                    sourceCode: iimmgg,
                    description: `<p>1. rész rövid leírása</p><p>A RWBY csapat egy hatalmas szigetre mosódik ismeretlen helyen, Jaune-nal és Neó-val. Miközben barátaik, valamint Atlas és Mantle lakói átutazzák Vacuo-t.</p>`
                },
                {
                    buttonTitle: `2. rész`,
                    episodeTitle: "Altercation at the Auspicious Auction / Változás a Kedvező Árverésen",
                    sourceCode: iimmgg,
                    description: `<p>2. rész rövid leírása</p><p>Amelyben az RWBY csapat többet kapnak, mint amennyiért cserélték.</p>`
                },
                {
                    buttonTitle: `3. rész`,
                    episodeTitle: "Rude, Red, and Royal / Goromba, Vörös, és Királyi",
                    sourceCode: iimmgg,
                    description: `<p>3. rész rövid leírása</p><p>Amelyben megszegik a játékszabályokat.</p>`
                },
                {
                    buttonTitle: `4. rész`,
                    episodeTitle: "A Cat Most Curious / A Legkíváncsibb Macska",
                    sourceCode: iimmgg,
                    description: `<p>4. rész rövid leírása</p><p>Amelyben új ismeretségek születnek.</p>`
                },
                {
                    buttonTitle: `5. rész`,
                    episodeTitle: "The Parfait Predicament / A tökéletesen kínos helyzet",
                    sourceCode: iimmgg,
                    description: `<p>5. rész rövid leírása</p><p>Amelyben egy desszert van összeállítva.</p>`
                },
                {
                    buttonTitle: `6. rész`,
                    episodeTitle: "Confessions Within Cumulonimbus Clouds / Vallomások a gomolyfelhőkben",
                    sourceCode: iimmgg,
                    description: `<p>6. rész rövid leírása</p><p>Amelyben a régi barátok újraegyesülnek.</p>`
                },
                {
                    buttonTitle: `7. rész`,
                    episodeTitle: "The Perils of Paper Houses / A Papírházak Veszedelmei",
                    sourceCode: iimmgg,
                    description: `<p>7. rész rövid leírása</p><p>Amelyben tervek és menetrendek készülnek.</p>`
                },
                {
                    buttonTitle: `8. rész`,
                    episodeTitle: "Tea Amidst Terrible Trouble / Tea Szörnyű Bajok Közepette",
                    sourceCode: iimmgg,
                    description: `<p>8. rész rövid leírása</p><p>Amiben egy kis tea kiömlött.</p>`
                },
                {
                    buttonTitle: `9. rész`,
                    episodeTitle: "A Tale Involving a Tree / Egy mese fával karöltve",
                    sourceCode: iimmgg,
                    description: `<p>9. rész rövid leírása</p><p>In which a door is encountered.</p>`
                },
                {
                    buttonTitle: `10. rész`,
                    episodeTitle: "Of Solitude and Self / Magányról és Önvalóról",
                    sourceCode: iimmgg,
                    description: `<p>10. rész rövid leírása</p><p>In which a choice must be made.</p>`
                },
                {
                    buttonTitle: `Bónusz`,
        ...
        },
        {
            ...
            projectSynopsis: "Szinopszis", // https://rwby.fandom.com/wiki/Justice_League_x_RWBY:_Super_Heroes_and_Huntsmen,_Part_One
            ...
            episodes: [ // Nothing
            {
                ...
                episodeTitle: "Part I",
                sourceCode: iimmgg,
                description: `<p>Film rövid leírása</p><p>-Nincsen elérhető leírás-<br>Debütálás: 2023.04.25.</p>`
            },
            {
                buttonTitle: `Part II`,
                episodeTitle: "Part II",
                sourceCode: iimmgg,
                description: `<p>Film rövid leírása</p><p>-Nincsen elérhető leírás-<br>Debütálás: 2023.10.17.</p>`
            }
            ]
        },
        {
            projectTitle: "Trailers",
            projectSynopsis: "Sorozat Szinopszis", // https://rwby.fandom.com/wiki/Trailers
            ...
            episodes: [ // https://rwby.fandom.com/wiki/Trailers
                {
                    ...
                    sourceCode: iimmgg,
                    description: `<p>1. rész rövid leírása</p><p>„<i>Mindannyian elvesztettünk valamit, és láttam, hogy a veszteség milyen hatással lehet az emberekre. De ha minden alkalommal feladnánk, amikor veszítettünk, akkor soha nem tudnánk előre lépni.</i>”<br><span style="float:right;">- Ruby Rose</span>&nbsp</p>`
                },
                {
                    buttonTitle: `White`,
                    episodeTitle: "White Trailer",
                    sourceCode: iimmgg,
                    description: `<p>2. rész rövid leírása</p><p>„<i>Nem tudom, kinek képzeli magát, de hadd mondjam el, ki vagyok: egy hős unokája vagyok, és egy gazember gyermeke. Egy bukott Királyság polgára vagyok, és a semmi örököse. Engem nem a nevem határoz meg, mert én leszek az, aki meghatározza.</i>”<br><span style="float:right;">- Weiss Schnee</span>&nbsp</p>`
                },
                {
                    buttonTitle: `Black`,
                    episodeTitle: "Black Trailer",
                    sourceCode: iimmgg,
                    description: `<p>3. rész rövid leírása</p><p>„<i>Egy egyszerű élet nem lenne az én életem! A családom, a barátaim, a kultúrám. Hozzájuk tartozom, éppúgy, mint ők hozzám. Mindezt feladni nem egyszerűség lenne, hanem árulás.</i>”<br><span style="float:right;">- Blake Belladonna</span>&nbsp</p>`
                },
                {
                    buttonTitle: `Yellow`,
                    episodeTitle: "Yellow Trailer",
                    sourceCode: iimmgg,
                    description: `<p>4. rész rövid leírása</p><p>„<i>A veszteségeim, a kudarcaim. Ezek mindennél jobban formáltak azzá, aki vagyok, és megmutatták, hogyan kell fejlődnöm. Ha valami hiányzik, az nem azért van, mert elvesztettem. Ez azért van, mert még nem találtam meg. És ennek egyetlen módja a folytatás.</i>”<br><span style="float:right;">- Yang Xiao Long</span>&nbsp</p>`
                },
            ]
        },
        {
            projectTitle: "Shorts",// https://rwby.fandom.com/wiki/Trailers
            projectSynopsis: "Sorozat Szinopszis",
            ...
            episodes: [ // https://rwby.fandom.com/wiki/Trailers
                {
                    ...
                    description: `<p>Rövid leírás</p><p>It's been several months since the Fall of Beacon, and the world of Remnant is still recovering. Tensions are high, lives have been lost, and the members of Team RWBY... are divided. Each of our heroines now faces a journey of their own.</p>`
                },
                {
                    ...
                    description: `<p>Rövid leírás</p><p>All her life, Weiss Schnee has lived a privileged and pampered life... but it did not come without its own hardships.</p>`
                },
                {
                    buttonTitle: `Volume 5`,
                ...
                },
                {
                    ...
                    description: `<p>Rövid leírás</p><p>YTudod, hogy Ruby megállíthatatlan a kaszájával, de Yang ismeri a kézi küzdelem valódi erejét. Egy fegyvermentes edzés kellős közepén Yang meg tudja győzni a nővérét a fegyver nélküli harc fontosságáról?</p>`
                },
                {
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=-1
                {
                    ...
                    description: `<p>1. rész rövid leírása</p><p>Egy kiegészítő sorozat első epizódja, amely Remnant történetét és tudományát taglalja. Ez az epizód a Porkristályok titokzatos erejével foglalkozik.</p>`
                },
                {
                    buttonTitle: `2. rész`,
                    ...
                    description: `<p>2. rész rövid leírása</p><p>Egy kiegészítő sorozat második epizódja, amely a Remnant történetét és tudományát taglalja. Ebben a részben információkat tár fel a négy Királyság helyszíneiről, politikájáról és katonai struktúráiról.</p>`
                },
                {
                    buttonTitle: `3. rész`,
                ...
                },
                {
                    ...
                    sourceCode: iimmgg,
                    description: `<p>13. rész rövid leírása</p><p>Bemutatja a főbb királyságokon kívüli helyeket Renmant világában, beleértve a falvak létezésének okait és a veszélyeket, amelyekkel szembe kell nézniük.</p>`
                },
                {
                    buttonTitle: `14. rész`,
                ...
                },
                {
                    ...
                    sourceCode: iimmgg,
                    description: `<p>15. rész rövid leírása</p><p>A Remnant leghíresebb Por cégének árnyas háttértörténete.</p>`
                },
                {
                    buttonTitle: `16. rész`,
                    episodeTitle: "The Great War / A Nagy Háború",
                    sourceCode: iimmgg,
                    description: `<p>16. rész rövid leírása</p><p>Qrow továbbra is többet mesél a Remnant világáról, ezúttal egy hatalmas háborúról beszél, amely örökre megváltoztatta a világot. Egyben jobban betekintést nyújt abba is, hogy miért van a világ a jelenlegi állapotában.</p>`
                }
            ]
        },
        {
            projectTitle: "RWBY: Fairy Tales", // +(szino.) https://rwby.fandom.com/wiki/RWBY:_Fairy_Tales
            projectSynopsis: "Sorozat Szinopszis", // ep+: https://tvtropes.org/pmwiki/pmwiki.php/WebAnimation/RWBYFairyTales
            ...
            episodes: [ // https://www.imdb.com/title/tt15830868/episodes?season=1&ref_=tt_eps_sn_1
                ...
                },
                {
                    ...
                    description: `<p>1. rész rövid leírása</p><p>A Grimmek sétáló borzalmak, amelyek a vadonban járnak... de vannak olyanok, amelyek közelebb hozzák a rettegést az otthonhoz.</p>`
                },
                {
                    buttonTitle: `2. rész`,
                    ...
                    description: `<p>2. rész rövid leírása</p><p>Egy magányos vadász egy mocsaras falut véd, amíg be nem tör a katasztrófa. A gyerekei felveszik a palástot?</p>`
                },
                {
                    buttonTitle: `3. rész`,
                    ...
                    description: `<p>3. rész rövid leírása</p><p>Ozpin két különböző eredetmítoszt mesél a Faunuszokkal kapcsolatban.</p>`
                },
                {
                    buttonTitle: `4. rész`,
                    ...
                    description: `<p>4. rész rövid leírása</p><p>A királyi ajándék többnek bizonyul, mint amilyennek látszik.</p>`
                },
                {
                    buttonTitle: `5. rész`,
                    ...
                    description: `<p>5. rész rövid leírása</p><p>Nem minden történetnek van egy „boldog, amíg meg nem hal.”</p>`
                },
                {
                    buttonTitle: `6. rész`,
                    ...
                    description: `<p>6. rész rövid leírása</p><p>Egy fiatal fiú találkozik egy titokzatos harcossal, aki messziről védi faluját.</p>`
                }
            ]
        },
        {
            projectTitle: "RWBY Chibi (1.évad)",
            projectSynopsis: "Sorozat Szinopszis", // Nothing
...
function EpisodeDefault(){
    ...
    document.getElementById("episodeTitle").innerHTML = `${videoSources.series[(+localStorage.getItem('result')) - 1].projectSynopsis}`;
